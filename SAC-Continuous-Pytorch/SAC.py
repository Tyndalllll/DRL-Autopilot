...
class SAC_Agent(object):
	...
	def save(self,dict_a,dict_c):
		torch.save(self.actor.state_dict(), dict_a)
		torch.save(self.q_critic.state_dict(), dict_c)


	def load(self,dict_a,dict_c):
		""" self.actor = torch.nn.DataParallel(self.actor)
		self.q_critic = torch.nn.DataParallel(self.q_critic) """

		self.actor.load_state_dict(torch.load(dict_a))
		self.q_critic.load_state_dict(torch.load(dict_c))
